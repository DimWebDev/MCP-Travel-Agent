Below is a **clean, self-contained `README.md`** that replaces every scattered note, script, or guide with a single authoritative source.
Copy it into the project root and delete the duplicate files (*Setup.md*, old README fragments, etc.).
All paths, commands, and version pins match your current repository state (Python 3.11, Poetry, MCP SDK 1.12, no frontend yet).
...
Happy hacking — and enjoy building your MCP-powered travel companion! ✈️
